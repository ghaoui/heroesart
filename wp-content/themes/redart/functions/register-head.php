...
function redart_enqueue_scripts() {
	...
	// ie scripts ----------------------------------------------------------------
	wp_enqueue_script('html5shiv', 'https://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.2/html5shiv.min.js', array(), '3.7.2', true);
	wp_enqueue_script('excanvas', 'https://cdn.jsdelivr.net/excanvas/r3/excanvas.js', array(), '2.0', true);	

	wp_script_add_data( 'html5shiv', 'conditional', 'IE' );
	wp_script_add_data( 'excanvas', 'conditional', 'IE' );
